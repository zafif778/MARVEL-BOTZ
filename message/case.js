...
if (!isHaruka) return sendButMessage(from, lang.noregis(pushname), `Klik Button Untuk Verify`, [{buttonId: '.daftar',buttonText: {displayText: `Daftar`,},type: 1,}], {quoted: fgif});
				sendButLocation(from, lang.menu(prefix, salam, pushname, tanggal, time, runtime), '*© Created By Lexxy Official* 🇮🇩', thumbnail, [{buttonId: '.owner', buttonText: {displayText: 'Owner'}, type: 1},{buttonId: '.infobot', buttonText:{displayText: 'Infobot'}, type: 1}], {quoted: mek})
				break
case 'infobot':
if (!isHaruka) return sendButMessage(from, lang.noregis(pushname), `Klik Button Untuk Verify`, [{buttonId: '.daftar',buttonText: {displayText: `Daftar`,},type: 1,}], {quoted: fgif});
			reply(`━➤ 「 𝙄𝙉𝙁𝙊 𝘿𝙀𝙑 」
✍️ 𝙎𝙘𝙧𝙞𝙥𝙩 𝙈𝙖𝙙𝙚 𝙞𝙣 𝘽𝙮 Marvel Official
🌟 𝙑𝙚𝙧𝙨𝙞𝙤𝙣 : 18.0
📈 𝙇𝙖𝙨𝙩 𝙐𝙥𝙙𝙖𝙩𝙚 : 1.0
📃 𝙇𝙞𝙣𝙠 𝙎𝙘 : Chat wa.me/6285892439939

📦 𝙂𝙧𝙤𝙪𝙥 1 :
https://chat.whatsapp.com/DiexeOhNqQv5Qsm6Y2vD4d
📦 𝙂𝙧𝙤𝙪𝙥 2 :
...
reply(`*OPEN SEWA BOT*
_LIST HARGA:_
${dbs}1 BULAN : ${sewa1bulan}
2 BULAN : ${sewa2bulan}
3 BULAN : ${sewa3bulan}
4 BULAN : ${sewa4bulan}
PERMANEN : ${sewapermanen}
Minat? Chat Owner:
Wa.me/${ownernumber}${dbs}`)
break
case 'pinterest': 
if (!isHaruka) return sendButMessage(from, lang.noregis(pushname), `Klik Button Untuk Verify`, [{buttonId: '.daftar',buttonText: {displayText: `Daftar`,},type: 1,}], {quoted: fgif});
...
if (args.length ==0) return reply(`*Example ${prefix + command} Lexxy*`)
tp = args.join (" ")
ttp = await getBuffer(`https://hardianto.xyz/api/ttpcustom?text=${encodeURI(q)}&color=black&apikey=hardianto`)
haruka.sendMessage(from, ttp, sticker, { quoted: mek })
break
case 'attp':
if (!isUser) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: mek})
if (args.length ==0) return reply(`*Example ${prefix + command} Lexxy*`)
attp = args.join(" ")
atp = await getBuffer(`https://hardianto.xyz/api/maker/attp?text=${encodeURI(q)}&apikey=hardianto`)
haruka.sendMessage(from, atp, sticker, { quoted: mek })
break
//maker textpro
...
haruka.deleteMessage(from, { id: mek.message.extendedTextMessage.contextInfo.stanzaId, remoteJid: from, fromMe: mek })
break
...
const gky = speed();
const gby = speed() - gky
reply(`𝐒𝐩𝐞𝐞𝐝 : *${gby.toFixed(4)}* 𝘚𝘦𝘤𝘰𝘯𝘥`)
break
...
if (!isHaruka) return sendButMessage(from, lang.noregis(pushname), `Klik Button Untuk Verify`, [{buttonId: '.daftar',buttonText: {displayText: `Daftar`,},type: 1,}], {quoted: fgif});
			...
			break          
			case 'nekopoi1':
qute = fs.readFileSync('./foto/neko.jpg') 
haruka.sendMessage(from, qute, image, { quoted: mek, caption: 'NIH LINKNYA: https://www2.zippyshare.com/d/z9dcY6Nr/791216/%5bNekoPoi%5d_Akina_to_Onsen_de_H_Shiyo%5b360P%5d%5bnekopoi.care%5d.mp4\n\nNOTE SIAPKAN TISU'})
break
case 'nekopoi2':
qute = fs.readFileSync('./foto/neko.jpg') 
haruka.sendMessage(from, qute, image, { quoted: mek, caption: 'NIH LINKNYA: https://www4.zippyshare.com/d/j7PFLGUY/946757/%5bNekoPoi%5d_Tsuma_ga_Kirei_ni_Natta_Wake_-_02_%5b360P%5d_%5bnekopoi.care%5d.mp4\n\nNOTE SIAPKAN TISU'})
break
case 'nekopoi3':
qute = fs.readFileSync('./foto/neko.jpg') 
haruka.sendMessage(from, qute, image, { quoted: mek, caption: 'NIH LINKNYA: https://www111.zippyshare.com/d/EK5uqIMh/566060/%5bNekoPoi%5d_Megane_no_Megami_-_01_%5b360P%5d_%5bnekopoi.care%5d.mp4\n\nNOTE SIAPKAN TISU'})
break
case 'nekopoi4':
qute = fs.readFileSync('./foto/neko.jpg') 
haruka.sendMessage(from, qute, image, { quoted: mek, caption: 'NIH LINKNYA: https://www109.zippyshare.com/d/2ebALhhS/463654/%5bNekoPoi%5d_Watashi_ga_Toriko_-_02%5b360P%5d%5bnekopoi.care%5d.mp4\n\nNOTE SIAPKAN TISU'})
break
case 'nekopoi5':
qute = fs.readFileSync('./foto/neko.jpg') 
haruka.sendMessage(from, qute, image, { quoted: mek, caption: 'NIH LINKNYA: https://www115.zippyshare.com/d/LmzOkRAI/313299/%5bNekoPoi%5d_Chichi-iro_Toiki_-_01_%5b360P%5d%5bnekopoi.care%5d.mp4\n\nNOTE SIAPKAN TISU'})
break
case 'nekopoi6':
qute = fs.readFileSync('./foto/neko.jpg') 
haruka.sendMessage(from, qute, image, { quoted: mek, caption: 'NIH LINKNYA: https://www89.zippyshare.com/d/SgEHvrJs/42812/%5bNekoPoi%5d_Chichi-iro_Toiki_-_02_%5b360P%5d%5bnekopoi.care%5d.mp4\n\nNOTE SIAPKAN TISU'})
break
case 'nekopoi7':
qute = fs.readFileSync('./foto/neko.jpg') 
haruka.sendMessage(from, qute, image, { quoted: mek, caption: 'NIH LINKNYA: https://www66.zippyshare.com/d/j0ivbciL/520411/%5bNekoPoi%5d_Onna_Maou_Melissa_no_H_na_Boukenki_-_01_%5b360P%5d_%5bnekopoi.care%5d.mp4\n\nNOTE SIAPKAN TISU'})
break
case 'nekopoi8':
qute = fs.readFileSync('./foto/neko.jpg') 
haruka.sendMessage(from, qute, image, { quoted: mek, caption: 'NIH LINKNYA: https://www71.zippyshare.com/d/M225YIrR/535656/%5bNekoPoi%5d_Buta_no_Gotoki_Sanzoku_ni_Torawarete_Shojo_wo_Ubawareru_Kyonyuu_Himekishi_Onna_Senshi_-_01%5b360P%5d%5bnekopoi.care%5d.mp4\n\nNOTE SIAPKAN TISU'})
break
case 'nekopoi9':
qute = fs.readFileSync('./foto/neko.jpg') 
haruka.sendMessage(from, qute, image, { quoted: mek, caption: 'NIH LINKNYA: https://www49.zippyshare.com/d/bdwYjaXS/605790/%5bNekoPoi%5d_Akebi_no_Hana___Maho_-_01_%5b360P%5d_%5bnekopoi.pro%5d.mp4\n\nNOTE SIAPKAN TISU'})
break
...
case 'infogempa':
                    ...
                    await haruka.sendMessage(from, get_buffer, image, { quoted: mek, caption: ini_txt })
                    break
                case 'tebakumur':
                    if (args.length == 0) return reply(`Example: ${prefix + command} Lexxy`)
                    ini_name = args.join(" ")
...
await haruka.sendMessage(from, { degreesLatitude: get_result.latitude, degreesLongitude: get_result.longitude }, location, { quoted: mek })
reply(ini_txt)
break
...
case 'kaneki':
if (args.length ==0) return reply(`*Example ${prefix + command} Lexxy*`)
ts = await getBuffer(`https://melcanz.com/${command}?nama=${q}&apikey=${MelcanzApi}`)
haruka.sendMessage(from, ts, image, { quoted: mek, caption: `*Logo ${command}*` })
break
