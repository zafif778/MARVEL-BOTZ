...
const starts = async (haruka = new WAConnection()) => {
    ...
    haruka.browserDescription = [ 'MARVEL-BOTZ', 'Chrome', '3.0' ]
	CFonts.say('MARVEL-BOTZ', {
		font: 'block',
    	color: ['#ff9c00'],
    	align: 'center',
		})
	CFonts.say(`© Created By Marvel Official`, {
		font: 'console',
		align: 'center',
    ...
    haruka.on('qr', () => {
        console.log(color('[','white'), color('!','red'), color(']','white'), color(' Scan qr Om Tante maks 20 detik sebelum qr expired'))
    })
